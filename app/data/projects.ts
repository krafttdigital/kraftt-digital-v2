...
export const projects: Project[] = [
  {
    ...
    evidenceNote: 'Needs a dated ranking screenshot before publish.',
  ...
  },
  {
    ...
    outcomeType: 'Measured',
    evidenceNote: 'Needs dated evidence for the named queries before publish.',
  ...
  },
  {
    ...
    package: '[PENDING: confirm package name]',
  ...
  },
  {
    ...
    problem: '[PENDING: project context needed]',
    context: 'This work belongs to a founder-led internal venture and is presented as practice, not client proof.',
    findings: ['[PENDING: project findings needed]'],
    approach: '[PENDING: project approach needed]',
    outcome: '[PENDING: project outcome needed]',
